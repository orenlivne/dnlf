...
difference; both are consistent with the $m\,\mathrm{polylog}\,m$ theory. Timing is serial and uncontended.
...
block diagonal---one near-linear solve per commodity (AC here, interchangeable with the default
