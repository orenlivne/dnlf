...
wall---yet NLF is faster than \emph{both} at every size beyond the smallest, setup-dominated point (where the
three agree to within ${\approx}2\%$), with a margin that widens with $m$ ($1.12\times$ the fair baseline at
