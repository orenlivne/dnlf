...
near-linear Laplacian solver wins. Our scaling study is therefore on irregular networks; for the time being the near-linear advantage is
established only here---on near-planar road networks a direct nested-dissection factorization is already
near-optimal. The most literal instance is selfish
